...
async def send_data(name, uri, sample):
...
def main():
    ...
    parser.add_argument('name', help="Name of headset")
    ...
    data_path = resource_filename(
        Requirement.parse("epoc_harvester_simulator"), "data")
    ...
    asyncio.get_event_loop().run_until_complete(
        send_data(args.name, args.url, sample))
